...
using MahApps.Metro.Controls.Editors;
...
namespace MahApps.Metro.Controls
{
    public class PropertyItem : ListBoxItem
    {
        ...
        public static readonly DependencyProperty IsReadOnlyProperty = DependencyProperty.Register(
            nameof(IsReadOnly), typeof(bool), typeof(PropertyItem), new PropertyMetadata(BooleanBoxes.FalseBox));
        ...
        public static readonly DependencyProperty IsExpandedEnabledProperty = DependencyProperty.Register(
            nameof(IsExpandedEnabled), typeof(bool), typeof(PropertyItem), new PropertyMetadata(BooleanBoxes.FalseBox));

        public bool IsExpandedEnabled
        {
            get => (bool) GetValue(IsExpandedEnabledProperty);
            set => SetValue(IsExpandedEnabledProperty, BooleanBoxes.Box(value));
        }
