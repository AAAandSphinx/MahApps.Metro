...
public class SearchBar : TextBox, ICommandSource
{
    ...
    public static readonly DependencyProperty IsRealTimeProperty = DependencyProperty.Register(
        nameof(IsRealTime), typeof(bool), typeof(SearchBar), new PropertyMetadata(BooleanBoxes.FalseBox));

    public static readonly RoutedEvent SearchStartedEvent =
        EventManager.RegisterRoutedEvent(nameof(SearchStarted), RoutingStrategy.Bubble,
            typeof(EventHandler<FunctionEventArgs<string>>), typeof(SearchBar));

    public SearchBar()
    {
        CommandBindings.Add(new CommandBinding(SearchBar.Search, (s, e) => OnSearchStarted()));
    }
    ...
    public static RoutedCommand? Search { get; } = new RoutedCommand(nameof(Search), typeof(SearchBar));
    ...
    public bool IsRealTime
    {
        ...
        set => SetValue(IsRealTimeProperty, BooleanBoxes.Box(value));
    }
